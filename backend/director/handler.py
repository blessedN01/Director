...
class VideoDBHandler:
    def __init__(self, collection_id="default"):
        self.videodb_tool = LocalVideoDBTool(collection_id=collection_id)
    ...
    def semantic_search(self, query, collection_id=None, limit=10):
        """Perform semantic search across videos."""
        return self.videodb_tool.semantic_search(query, collection_id, limit)

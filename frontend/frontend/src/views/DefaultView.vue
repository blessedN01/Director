...
<template>
  <main>
    <!-- Manual Interface Banner -->
    <div class="bg-blue-600 text-white px-4 py-3">
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex-1">
          <p class="text-sm">
            🎯 <strong>Manual VideoDB Interface Available:</strong> Full control over video processing, collections, search, and generation
          </p>
        </div>
        <div class="ml-4">
          <router-link
            to="/dashboard"
            class="inline-flex items-center px-3 py-1 border border-transparent text-sm font-medium rounded-md text-blue-600 bg-white hover:bg-blue-50"
          >
            Open Manual Interface
          </router-link>
        </div>
      </div>
    </div>
